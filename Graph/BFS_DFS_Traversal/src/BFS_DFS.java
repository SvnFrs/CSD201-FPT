...
*/
    public void solve() {
        ...
        graph.BFS(valueBegin);
        BFS = graph.getTraverSalResult().substring(0, graph.getTraverSalResult().length()-1);
        graph.DFS(valueBegin);
        DFS = graph.getTraverSalResult().substring(0, graph.getTraverSalResult().length()-1);
