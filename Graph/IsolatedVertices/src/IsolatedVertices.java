...
public class IsolatedVertices {
     ...
     */
    public void solve() {
//        IsolatedVertices =graph.IsolatedVertices();
        String tmp = graph.findIsolatedVertices();
        if (tmp == "") {
            IsolatedVertices = "There is a connected graph";
        } else {
            IsolatedVertices = tmp.substring(0, tmp.length() - 1);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        IsolatedVertices app = new IsolatedVertices();
        app.setFile(args);
        app.readData();
        app.solve();
        app.printResult();
