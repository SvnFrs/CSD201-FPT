...
//    }
    ...
    public void readData() {
       graph = new GPaper();
        try {
            ...
            System.out.println(NumberOfVertices + " " + countEdge);
            int start, end; int value;
    ...
    public static void main(String[] args) {
        ...
        FromListToMatrix app = new FromListToMatrix();
        app.setFile(args);
        app.readData();
        app.solve();
        app.printResult();
