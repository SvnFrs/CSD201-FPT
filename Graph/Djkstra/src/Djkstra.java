...
public class Djkstra {
    ...
    int NumberOfVertices, valueBegin, valueEnd;
...
*/
    public void solve() {
        graph.Dijkstra(valueBegin, valueEnd);
        graph.displayPath();
        
        sumDjkstra = graph.getSum()+"";
        djkstra = graph.getlResult();
        System.out.println(sumDjkstra);
